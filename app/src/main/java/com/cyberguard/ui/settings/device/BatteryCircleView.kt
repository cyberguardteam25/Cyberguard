...
class BatteryCircleView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        when {
            percentage <= 20 -> paint.color = Color.parseColor("#E40000") // red
            percentage in 21..59 -> paint.color = Color.parseColor("#FFA500") // orange
            percentage in 70..89 -> paint.color = Color.parseColor("#3CB371") // green
            percentage in 90..100 -> paint.color = Color.parseColor("#3b82f6") // blue
        }
